<?php
    ...
    if (isset($_FILES['new_profile'])){
        $message = changeProfilePicture($_SESSION['user']['username'] ,$_FILES['new_profile']);

    } else if (isset($_POST['clearProfile'])) {
        clearProfile($_SESSION['user']['username']);
    }
?>
        ...
        <div class="container main__container">
            <div class="settings">
                <form action="" method="POST" enctype="multipart/form-data">
                    <label for="new_profile">Choose a new profile picture</label>
                    <br><br>
                ...
                <form action="" method="POST">
                    <input type="submit" value="Clear Profile Picture" name="clearProfile">
                </form>
            </div>
        </div>
    </main>
